...
Measured on CLI v2.1.237 from raw PTY output (`ESC[?1049h`): each renderer against the opposite `tui` setting, and both variables together to establish which wins.
